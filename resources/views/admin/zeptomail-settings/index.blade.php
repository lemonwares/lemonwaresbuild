...
@section('content')
    <div class="mb-8">
        ...
        <p class="mt-3 lede">
            Transactional mail for password resets, account notices, and the public contact form.
            From address, contact inbox, logo, and API values here override
            <code class="rounded bg-blush-soft px-1">.env</code> fallbacks.
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.zeptomail-settings.update') }}" class="space-y-6">
        ...
        <section class="rounded-3xl border border-border bg-white p-6">
            <h2 class="text-lg font-bold text-black">Contact form inbox</h2>
            <p class="mt-1 text-sm text-on-blush/65">
            ...
            <div class="mt-5">
                <label class="mb-1.5 block text-xs font-semibold uppercase tracking-widest text-on-blush/60">Inbox address</label>
                <input
                    type="email"
