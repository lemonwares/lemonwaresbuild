...
@section('content')
    <div class="mb-8">
        ...
        <p class="lede mt-3">Customer business-email orders billed on this site and provisioned through TrekMail.</p>
    </div>
    ...
    <div class="overflow-x-auto rounded-3xl border border-border bg-white">
        <table class="min-w-full text-left text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-on-blush/60">No email orders yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
