...
@section('content')
    <div class="mx-auto max-w-md rounded-4xl border border-border bg-white p-6 sm:p-8">
            ...
            <form method="POST" action="{{ route('password.update') }}" class="mt-6 space-y-5" data-submit-form>
                @csrf
                ...
                <x-ui.submit-button :label="__('account.reset_title')" :loading="__('account.saving')" class="btn btn-primary w-full" />
            </form>
        </div>
@endsection
