...
return [
    ...
    'case_studies' => [
        ...
        'section_label' => 'Shipped work',
        'section_title' => 'Selected products and platforms',
        'section_lede' => 'Each case is something we built or migrated for a real team — not a generic service pitch.',
        'client_label' => 'Client',
        ...
        'live_preview_frame_title' => 'Live preview of :title',
        'back' => 'All case studies',
        'empty_title' => 'Case studies are on the way',
        'empty_lede' => 'Meanwhile, tell us about your next build.',
        'help_title' => 'Ready to ship yours?',
        'help_lede' => 'Tell us what you need — a product build, migration, or Mailemon rollout — and we will map the path.',
        'cta_projects' => 'Contact us',
    ],
    'services' => [
        'hosting' => [
            'title' => 'Cloud Hosting',
